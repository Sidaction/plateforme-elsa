			...
			<div ng-show="$root.show_account_connection_popup_form === 'create'" class="jackmail_settings_login">
				<div class="jackmail_input_create_account_container_two_fields">
					<p class="jackmail_input_create_account_container"
					   ng-class="ac.login_error.firstname ? 'jackmail_input_create_account_container_error' : ''">
						<input type="text" ng-model="ac.create_login.firstname"
						       placeholder="<?php esc_attr_e( 'First name', 'jackmail-newsletters' ) ?>"
						       ng-keyup="ac.recheck_account_creation()"/>
						<span class="dashicons dashicons-editor-help"
						      title="<?php esc_attr_e( 'Please enter your last name', 'jackmail-newsletters' ) ?>">
						</span>
					</p>
					<p class="jackmail_input_create_account_container"
					   ng-class="ac.login_error.lastname ? 'jackmail_input_create_account_container_error' : ''">
						<input type="text" ng-model="ac.create_login.lastname"
				...
				<p class="jackmail_input_create_account_container"
				   ng-class="ac.login_error.email ? 'jackmail_input_create_account_container_error' : ''">
				...
				<div class="jackmail_input_create_account_container_two_fields">
					<p class="jackmail_input_create_account_container"
					   ng-class="ac.login_error.password ? 'jackmail_input_create_account_container_error' : ''">
						<input type="password" ng-model="ac.create_login.password"
						       placeholder="<?php esc_attr_e( 'Password', 'jackmail-newsletters' ) ?>"
						       ng-keyup="ac.recheck_account_creation()"/>
						<span class="dashicons dashicons-editor-help"
						      title="<?php esc_attr_e( 'Password length must be at least 8 characters', 'jackmail-newsletters' ) ?>">
						</span>
					</p>
					<p class="jackmail_input_create_account_container"
					   ng-class="ac.login_error.password ? 'jackmail_input_create_account_container_error' : ''">
						<input type="password" ng-model="ac.create_login.password_confirmation"
