...
class adminManager {
    ...
    public function __construct() {
	   ...
	   add_action( 'wp_login_failed', array(&$this, 'redirect_login_failed'));
        ...
        if (in_array('author', $this->user_role)) {
    ...
    function extra_user_profile_fields($user) {
        ...
        <table class="form-table">
            <tr>
                <th><label for="programme"><?php _e("Programme"); ?></label></th>
                <td>
        <?php cnLib::custom_taxonomy_dropdown('programme_assoc', '', 'Sélectionnez', '', esc_attr(get_the_author_meta('programme_assoc', $user->ID)),false); ?>
                </td>
            </tr>
        </table>
        <?php
    ...
    function save_extra_user_profile_fields($user_id) {
        ...
        update_user_meta($user_id, 'programme_assoc', $_POST['programme_assoc']);
    }
    ...
    function soi_login_redirect($redirect_to, $request, $user) {
        if (is_array($user->roles)) {
            if (in_array('administrator', $user->roles)) {
                ...
                return get_bloginfo('url') . '/espace-partenaires/';
            } else {
                return get_bloginfo('url') . '/espace-partenaires/';
            }
        }
