jQuery( document ).ready(function() {
	...
	if(jQuery("#acteursLocauxcontent").length) {
	
var adjustheight = 266;
// The "more" link text
...
$(".adjust").toggle(function() {
		$(this).parents("div:first").find("#acteursLocauxcontent").css('height', 'auto').css('overflow', 'visible');
		$(this).text(lessText);
	}, function() {
		$(this).parents("div:first").find("#acteursLocauxcontent").css('height', adjustheight).css('overflow', 'hidden');
		$(this).text(moreText);
});
	}				
