<?php global $cnSite; 
	// a supprimer pour dev : uniquement visible en super admin
	/*global $current_user;
    get_currentuserinfo();
	if (!in_array('administrator', $current_user->roles)) exit;*/
	// fin a supprimer
...
<head>
  ...
  <script src="http://cdnjs.cloudflare.com/ajax/libs/gsap/1.11.5/TweenMax.min.js"></script>
    ...
    <script type="text/javascript" src="<?php echo $cnSite->templatelink; ?>/_js/freetiles.js"></script>
    ...
    <div id="topFollow">
        <div id="topFollowWrapper">
            <ul>
                ...
                <li class="rssTop"><a href="/feed"></a></li>
            </ul>
        </div>
    </div>
...
<div class="widget_wysija_cont html_wysija"><div id="msg-form-wysija-html53511c8a3fd9d-1" class="wysija-msg ajax"></div><form id="form-wysija-html53511c8a3fd9d-1" method="post" action="#wysija" class="newsletter">
