...
<main id="ressource">
    ...
    <section class="sec_ressource-content">
        <div class="grid gap-xxl wrapper">
            <div class="s-8col">
                ...
                <div class="navigation-buttons flex space">
            ...
            <div class="s-4col flex column gap-s end-y mb-l">
                ...
                ?>
                    <?php if ($kind === 'pdf') : ?>
                        <button class="btn btn--secondary" onclick="openPDFPopin('<?= $info['url'] ?>')">
                    ...
                    <a href="<?= $info['url'] ?>" title="<?= $info['title'] ?>" class="btn" target="_blank" <?= $kind === 'pdf' ? 'download' : '' ?>>
                    ...
                    <script>
                        function openPDFPopin(url) {
                            var popinOverlay = document.getElementById('pdf-popin-overlay');
                            var iframe = document.getElementById('pdf-popin-iframe');
                        ...
                        function closePdfPopin() {
                            var popinOverlay = document.getElementById('pdf-popin-overlay');
                            var iframe = document.getElementById('pdf-popin-iframe');

                            // Hide the popin and reset the iframe URL
